...
from ..myapp.sample import Student , is_eligible_for_degree
...
def test_student_is_eligible_for_degree_with_param(make_dummy_student,credits ,expected):
...
def test_student_is_eligible_for_degree_indirect(dummy_student ,expected):
